        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="prose prose-sm md:prose-base max-w-none space-y-6">
            <p className="text-sm md:text-base text-gray-700 leading-relaxed">
              <span className="text-amber-600 font-semibold">Travel Stays</span> is constantly looking for partners and agents worldwide to work with. We offer attractive commission to interested qualified parties who would like to advertise our premium collection of luxury villas in Phuket, Bali, and Koh Samui, to offer to their clientele. Please{" "}
              <a href="/contact-us" className="text-amber-600 hover:text-amber-700 underline">
                Contact Us
              </a>{" "}
            ...
            <p className="text-sm md:text-base text-gray-700 leading-relaxed">
              The marketing materials and other resources of all of our luxury villas listed in this website such as the high resolution images, videos, floor plans, and descriptions are available for download and use to our registered agents only.
            </p>
        ...
        <div className="container mx-auto px-4 max-w-6xl flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="max-w-3xl">
            <p className="text-sm md:text-base leading-relaxed text-gray-300">
              Interested to become one of our agents? We offer attractive commission rates for both new and established agents with a focus on high-end properties and luxury travel. Contact us to register as an official partner of Travel Stays.
            </p>
          </div>
          <Button 
            variant="outline" 
